<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpstudy\PHPTutorial\WWW\dy\public/../application/index\view\user\main.html";i:1572060787;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
    <head>
        ...
        <script>
            ...
            var on = JSON.stringify({"oper":"on"});
            var off = JSON.stringify({"oper":"off"});
        </script>
    </head>
    <body class="index">
        <!-- 顶部开始 -->
                ...
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
							...
							<li>
                                <a onclick="xadmin.add_tab('抖音号','/index/Base/no')">
                                    <i class="iconfont">&#xe6b8;</i>
                                    <cite>抖音号</cite></a>
                            </li>
							<li>
                                <a onclick="xadmin.add_tab('设备','/index/Base/device')">
                                    <i class="iconfont">&#xe70e;</i>
                                    <cite>设备</cite></a>
                            </li>
							<li>
							...
							<li>
                                <a onclick="xadmin.add_tab('控件','/index/Base/widget')">
                                    <i class="iconfont">&#xe70e;</i>
                                    <cite>控件</cite></a>
                            </li>
                        </ul>
	...
	function ctrlScript(sign){
		$.post('/dyOper?action=setScriptStatus',{'sign':sign},function(j){
			if(j.status == 'success'){
